# 📘 PEMBAGIAN TUGAS PENYUSUNAN SKRIPSI KOLEKTIF
...
File ini digunakan untuk mendaftarkan bagian skripsi yang akan dikerjakan oleh masing-masing mahasiswa.  
Setiap mahasiswa wajib **mengajukan bagian** melalui _Pull Request (PR)_ sebelum mulai mengedit `skripsi-kelompok.md`.

### 🔹 Aturan Umum

1. Mahasiswa **tidak boleh langsung menulis di `skripsi-kelompok.md`** sebelum disetujui.
2. Format nama branch:
   - Pengajuan bagian → `pendaftaran-[NIM]`
   - Kontribusi isi → `kontribusi-[NIM]`
3. Setiap mahasiswa hanya boleh mengerjakan **1 bagian utama skripsi.**
4. Kolom **Status** diisi oleh dosen pembimbing (✅ Disetujui / 🔄 Revisi / ❌ Ditolak).
...
| 10  | Jafar Siddik Aulia Rahman | 301220005 | Bab I - Rumusan Masalah           | Menulis pertanyaan penelitian                       | Disetujui ✅ |
| 11  | Rian Ali Muhamad Agustin  | 301220066 | Bab I - Batasan Masalah           | Menjelaskan batas ruang lingkup                     | Diajukan     |
...
| 31  |                           |           | Bab IV - Fitur Sistem             | Daftar fitur yang diimplementasikan                 | Diajukan     |
...
| 39  |                           |           | Bab V - Instalasi Sistem          | Panduan instalasi program                           | Diajukan     |
...
| 55  |                           |           | Reviewer 1                        | Reviewer isi dan format                             | Diajukan     |
| 56  |                           |           | Reviewer 2                        | Reviewer konten teknis                              | Diajukan     |
| 57  |                           |           | Dokumentator 1                    | Menulis laporan kolaborasi                          | Diajukan     |
...
✳️ Dosen dapat mengubah status menjadi:  
